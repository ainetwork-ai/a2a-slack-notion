...
import { Sidebar } from '@/components/notion/sidebar/sidebar';
import { SharePanel } from '@/components/notion/share-panel';
import { Breadcrumb } from '@/components/notion/breadcrumb';
import { CollaborativeEditor } from '@/components/notion/editor/collaborative-editor';
import { DatabaseView } from '@/components/notion/database/database-view';
import { HistoryPanel } from '@/components/notion/history-panel';
import { SaveAsTemplateDialog } from '@/components/notion/save-as-template-dialog';
...
export default function PageView() {
  ...
  async function exportPage(format: 'markdown' | 'csv') {
    ...
    const res = await fetch(`/api/v1/pages/${pageId}/export?format=${format}`, {
      method: 'POST',
      credentials: 'include',
    });
    if (!res.ok) return;
      ...
      <div className="flex h-screen">
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link
              href={`/notion/workspace/${workspaceId}`}
