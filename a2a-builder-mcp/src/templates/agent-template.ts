...
export function agentPackageJson(name: string, description: string) {
...
export function agentCardJson(config: AgentConfig, url?: string) {
...
export function serverTs(config: AgentConfig) {
...
export function agentCardTs(config: AgentConfig) {
...
export function agentCardTsClean(config: AgentConfig) {
...
export function taskHandlerTs(config: AgentConfig) {
